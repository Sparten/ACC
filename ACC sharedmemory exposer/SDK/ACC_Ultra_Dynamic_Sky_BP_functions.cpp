...
#include "ACC_Ultra_Dynamic_Sky_BP_parameters.hpp"
...
void AUltra_Dynamic_Sky_BP_C::UpdateTrackLights()
{
	static auto fn = UObject::FindObject<UFunction>("Function Ultra_Dynamic_Sky_BP.Ultra_Dynamic_Sky_BP_C.UpdateTrackLights");

	AUltra_Dynamic_Sky_BP_C_UpdateTrackLights_Params params;
